<?php
// Standalone demo for testing form builder functionality
// This file demonstrates the form builder without Moodle dependencies
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'save_form') {
        ...
        $_SESSION['saved_form'] = $formData;
        $_SESSION['success'] = 'Form saved successfully!';
        
        header('Location: demo_standalone.php');
        exit;
    }
}
...
<head>
    ...
    <title>Form Builder Demo - Moodle Plugin</title>
...
<body>
    ...
    <div class="feature-demo">
        <div class="container text-center">
            ...
            <p class="lead mb-4">Complete drag-and-drop form creation system with 12 field types, validation, and submission management</p>
            <div class="row mt-5">
                <div class="col-md-4">
                    <h5>✨ Easy to Use</h5>
                    <p>Click to add fields, configure properties, and create professional forms in minutes</p>
                </div>
                <div class="col-md-4">
                    <h5>🔧 12 Field Types</h5>
                    <p>Text, Email, Date, Dropdown, Radio, Checkbox, File Upload, and more</p>
                </div>
                <div class="col-md-4">
                    <h5>📊 Submission Management</h5>
                    <p>Built-in validation, email notifications, and comprehensive data collection</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <h2>Quick Start - Try These Examples</h2>
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h5>Contact Form</h5>
                                <button onclick="loadTemplate('contact')" class="btn btn-outline-primary">Load Template</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <h5>Survey Form</h5>
                                <button onclick="loadTemplate('survey')" class="btn btn-outline-primary">Load Template</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button onclick="loadTemplate('registration')" class="btn btn-outline-primary">Load Template</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <button type="button" onclick="clearForm()" class="btn btn-outline-warning">Clear All Fields</button>
                            <button type="button" onclick="previewForm()" class="btn btn-outline-info">Preview Form</button>
    ...
    <script>
        ...
        const templates = {
            contact: {
                ...
                fields: [
                    ...
                    {id: "field_3", type: "text", label: "Subject", required: true},
                    {id: "field_4", type: "textarea", label: "Message", required: true}
                ]
            },
            survey: {
                ...
                fields: [
                    {id: "field_1", type: "text", label: "Your Name", required: false},
                    ...
                    {id: "field_3", type: "select", label: "How did you hear about us?", required: false, options: ["Google", "Social Media", "Friend", "Advertisement", "Other"]},
                    {id: "field_4", type: "checkbox", label: "Would you recommend us?", required: false},
                    {id: "field_5", type: "textarea", label: "Additional Comments", required: false}
                ]
            },
            registration: {
                ...
                fields: [
                    {id: "field_1", type: "text", label: "Full Name", required: true},
                    {id: "field_2", type: "email", label: "Email Address", required: true},
                    {id: "field_3", type: "text", label: "Phone Number", required: true},
                    {id: "field_4", type: "select", label: "Ticket Type", required: true, options: ["Regular - $50", "VIP - $100", "Student - $25"]},
                    {id: "field_5", type: "number", label: "Number of Tickets", required: true},
                    {id: "field_6", type: "textarea", label: "Special Requirements", required: false}
                ]
            }
        };
            ...
            if (!["heading", "paragraph", "pagebreak"].includes(type)) {
                ...
                html += `
                    <div class="mb-3">
                        ...
                        <textarea id="prop-helptext" class="form-control" rows="2" onchange="updateFieldHelpText()">${fieldElement.dataset.helptext || ''}</textarea>
                    </div>
                `;
        ...
        function previewForm() {
            const formData = JSON.parse(document.getElementById("formdata").value || '{"fields":[]}');
            const formName = document.getElementById("form-name").value || "Untitled Form";
            
            let html = `<h4>${formName}</h4>`;
